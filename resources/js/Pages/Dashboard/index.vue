    ...
    <div class="flex items-center justify-center py-8 px-9 w-full h-full">
      <div class="h-full w-full max-w-7xl">
        ...
        <div class="py-8 flex gap-5 w-full justify-center">
          ...
          >
            ...
            <div class="w-full">
              ...
              >
                ...
                <tbody>
                  <tr v-for="(product, index) in best_product">
          ...
          >
            <div class="mb-3 flex flex-col pb-4">
              <h1 class="text-2xl font-bold mb-1">Should Restock Product</h1>
        ...
        >
          <div class="flex-1 bg-white rounded-xl border-gray-300 border p-5">
            ...
            <p class="text-gray-500">Best Selling Outlets This Week</p>
            <BarChart
              :chartData="outlets"
              :options="options"
              class="h-[200px] mt-5"
          ...
          <div class="flex-1 bg-white rounded-xl border border-gray-300 p-5">
            <h1 class="text-xl font-semibold">Best Employees</h1>
            <p class="text-gray-500">Best Selling Employees This Week</p>
            <BarChart
              :chartData="employees"
              :options="options"
              class="h-[200px] mt-5"
